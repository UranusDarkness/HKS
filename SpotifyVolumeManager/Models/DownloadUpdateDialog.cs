...
namespace AutoUpdaterDotNET
{
    ...
    {
        public readonly UpdateInfoEventArgs _args;
        ...
        public static List<SpotifyVolumeManager.Models.IProgressBarChangeListener> listener = new List<SpotifyVolumeManager.Models.IProgressBarChangeListener>();
        ...
        public static void AddListener(SpotifyVolumeManager.Models.IProgressBarChangeListener list)
        {
            listener.Add(list);
        }
        ...
        public void StartDownloadUpdate()
        {
            ...
            _webClient = SpotifyVolumeManager.Models.AutoUpdater.GetWebClient(uri, AutoUpdater.BasicAuthDownload);
        ...
        private void OnDownloadProgressChanged(object sender, DownloadProgressChangedEventArgs e)
        {
            ...
            foreach (SpotifyVolumeManager.Models.IProgressBarChangeListener listt in listener)
            {
                listt.ProgressBarChange(e.ProgressPercentage);
            }
        ...
        private void DownloadUpdateDialog_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (AutoUpdater.Mandatory && AutoUpdater.UpdateMode == Mode.ForcedDownload)
            {
                SpotifyVolumeManager.Models.AutoUpdater.Exit();
                return;
            }
